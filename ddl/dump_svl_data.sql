...
-- Started on 2019-10-24 12:29:49 -03
...
DROP DATABASE svl;
--
-- TOC entry 3256 (class 1262 OID 27831)
...
--
-- TOC entry 766 (class 1247 OID 31136)
...
COMMENT ON TABLE cms.artigos IS 'Dispara artigos para todos os condomínio. São artigos de auxílio para usuários que acessam o sistema';


--
-- TOC entry 311 (class 1259 OID 40384)
-- Name: artigos_globais; Type: TABLE; Schema: cms; Owner: postgres
--

CREATE TABLE cms.artigos_globais (
    id integer NOT NULL,
    firstdate timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    lastdate timestamp without time zone,
...
ALTER TABLE cms.artigos_globais OWNER TO postgres;

--
-- TOC entry 310 (class 1259 OID 40382)
-- Name: artigos_globais_id_seq; Type: SEQUENCE; Schema: cms; Owner: postgres
--

CREATE SEQUENCE cms.artigos_globais_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE cms.artigos_globais_id_seq OWNER TO postgres;

--
-- TOC entry 3294 (class 0 OID 0)
-- Dependencies: 310
-- Name: artigos_globais_id_seq; Type: SEQUENCE OWNED BY; Schema: cms; Owner: postgres
--

ALTER SEQUENCE cms.artigos_globais_id_seq OWNED BY cms.artigos_globais.id;
...
--
-- TOC entry 309 (class 1259 OID 32128)
-- Name: acionadores; Type: TABLE; Schema: config; Owner: postgres
--

CREATE TABLE config.acionadores (
    id integer NOT NULL,
    firstdate timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    lastdate timestamp without time zone,
    purgedate timestamp without time zone,
    ...
    lasttuser character varying(15),
    purgeuser character varying(15),
    leitora integer NOT NULL
);


ALTER TABLE config.acionadores OWNER TO postgres;

--
-- TOC entry 3298 (class 0 OID 0)
-- Dependencies: 309
-- Name: TABLE acionadores; Type: COMMENT; Schema: config; Owner: postgres
--

COMMENT ON TABLE config.acionadores IS 'Configura os acionadores interligados aos leitores';


--
-- TOC entry 308 (class 1259 OID 32126)
-- Name: acionadores_id_seq; Type: SEQUENCE; Schema: config; Owner: postgres
--

CREATE SEQUENCE config.acionadores_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE config.acionadores_id_seq OWNER TO postgres;

--
-- TOC entry 3299 (class 0 OID 0)
-- Dependencies: 308
-- Name: acionadores_id_seq; Type: SEQUENCE OWNED BY; Schema: config; Owner: postgres
--

ALTER SEQUENCE config.acionadores_id_seq OWNED BY config.acionadores.id;
...
--
-- TOC entry 305 (class 1259 OID 32100)
-- Name: controladoras; Type: TABLE; Schema: config; Owner: postgres
--

CREATE TABLE config.controladoras (
    id integer NOT NULL,
    firstdate timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    lastdate timestamp without time zone,
    purgedate timestamp without time zone,
...
ALTER TABLE config.controladoras OWNER TO postgres;

--
-- TOC entry 3302 (class 0 OID 0)
-- Dependencies: 305
-- Name: TABLE controladoras; Type: COMMENT; Schema: config; Owner: postgres
--

COMMENT ON TABLE config.controladoras IS 'Configura os equipamentos responsáveis pelo controle de acesso';


--
-- TOC entry 304 (class 1259 OID 32098)
-- Name: controladoras_id_seq; Type: SEQUENCE; Schema: config; Owner: postgres
--

CREATE SEQUENCE config.controladoras_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE config.controladoras_id_seq OWNER TO postgres;

--
-- TOC entry 3303 (class 0 OID 0)
-- Dependencies: 304
-- Name: controladoras_id_seq; Type: SEQUENCE OWNED BY; Schema: config; Owner: postgres
--

ALTER SEQUENCE config.controladoras_id_seq OWNED BY config.controladoras.id;


--
-- TOC entry 307 (class 1259 OID 32114)
-- Name: leitoras; Type: TABLE; Schema: config; Owner: postgres
--

CREATE TABLE config.leitoras (
    id integer NOT NULL,
    firstdate timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    lastdate timestamp without time zone,
    purgedate timestamp without time zone,
    ...
    lasttuser character varying(15),
    purgeuser character varying(15),
    controladora integer NOT NULL
);


ALTER TABLE config.leitoras OWNER TO postgres;

--
-- TOC entry 3304 (class 0 OID 0)
-- Dependencies: 307
-- Name: TABLE leitoras; Type: COMMENT; Schema: config; Owner: postgres
--

COMMENT ON TABLE config.leitoras IS 'Configura as leitoras conectadas as controladoras';


--
-- TOC entry 306 (class 1259 OID 32112)
-- Name: leitoras_id_seq; Type: SEQUENCE; Schema: config; Owner: postgres
--

CREATE SEQUENCE config.leitoras_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE config.leitoras_id_seq OWNER TO postgres;

--
-- TOC entry 3305 (class 0 OID 0)
-- Dependencies: 306
-- Name: leitoras_id_seq; Type: SEQUENCE OWNED BY; Schema: config; Owner: postgres
--

ALTER SEQUENCE config.leitoras_id_seq OWNED BY config.leitoras.id;
...
COMMENT ON TABLE config.tipo_cadastro IS 'Registra as configurações das controladoras de acesso';
...
--
-- TOC entry 303 (class 1259 OID 32081)
...
--
-- TOC entry 302 (class 1259 OID 32079)
...
--
-- TOC entry 296 (class 1259 OID 31563)
...
--
-- TOC entry 297 (class 1259 OID 31570)
...
--
-- TOC entry 301 (class 1259 OID 32072)
-- Name: tipo_inventario; Type: TABLE; Schema: operacional; Owner: postgres
--

CREATE TABLE operacional.tipo_inventario (
    id integer NOT NULL,
    firstdate timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    lastdate timestamp without time zone,
    purgedate timestamp without time zone NOT NULL,
...
ALTER TABLE operacional.tipo_inventario OWNER TO postgres;

--
-- TOC entry 300 (class 1259 OID 32070)
-- Name: tipo_inventario_id_seq; Type: SEQUENCE; Schema: operacional; Owner: postgres
--

CREATE SEQUENCE operacional.tipo_inventario_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE operacional.tipo_inventario_id_seq OWNER TO postgres;

--
-- TOC entry 3363 (class 0 OID 0)
-- Dependencies: 300
-- Name: tipo_inventario_id_seq; Type: SEQUENCE OWNED BY; Schema: operacional; Owner: postgres
--

ALTER SEQUENCE operacional.tipo_inventario_id_seq OWNED BY operacional.tipo_inventario.id;


--
-- TOC entry 298 (class 1259 OID 31572)
...
COMMENT ON TABLE operacional.tipo_servico IS 'Registra os tipos de inventários existentes para o condomínio';


--
-- TOC entry 299 (class 1259 OID 31579)
...
--
-- TOC entry 2739 (class 2604 OID 31581)
...
--
-- TOC entry 2741 (class 2604 OID 31582)
...
--
-- TOC entry 2743 (class 2604 OID 31583)
...
--
-- TOC entry 2745 (class 2604 OID 31584)
...
--
-- TOC entry 2747 (class 2604 OID 31585)
...
--
-- TOC entry 2749 (class 2604 OID 31586)
...
--
-- TOC entry 2751 (class 2604 OID 31587)
...
--
-- TOC entry 2753 (class 2604 OID 31588)
...
--
-- TOC entry 2755 (class 2604 OID 31589)
...
--
-- TOC entry 2757 (class 2604 OID 31590)
...
--
-- TOC entry 2759 (class 2604 OID 31591)
...
--
-- TOC entry 2763 (class 2604 OID 31592)
...
--
-- TOC entry 2765 (class 2604 OID 31593)
...
--
-- TOC entry 2767 (class 2604 OID 31594)
...
--
-- TOC entry 2769 (class 2604 OID 31595)
...
--
-- TOC entry 2771 (class 2604 OID 31596)
...
--
-- TOC entry 2773 (class 2604 OID 31597)
...
--
-- TOC entry 2775 (class 2604 OID 31598)
...
--
-- TOC entry 2857 (class 2604 OID 40387)
-- Name: artigos_globais id; Type: DEFAULT; Schema: cms; Owner: postgres
--

ALTER TABLE ONLY cms.artigos_globais ALTER COLUMN id SET DEFAULT nextval('cms.artigos_globais_id_seq'::regclass);


--
-- TOC entry 2777 (class 2604 OID 31599)
...
--
-- TOC entry 2855 (class 2604 OID 32131)
-- Name: acionadores id; Type: DEFAULT; Schema: config; Owner: postgres
--

ALTER TABLE ONLY config.acionadores ALTER COLUMN id SET DEFAULT nextval('config.acionadores_id_seq'::regclass);


--
-- TOC entry 2779 (class 2604 OID 31600)
...
--
-- TOC entry 2851 (class 2604 OID 32103)
-- Name: controladoras id; Type: DEFAULT; Schema: config; Owner: postgres
--

ALTER TABLE ONLY config.controladoras ALTER COLUMN id SET DEFAULT nextval('config.controladoras_id_seq'::regclass);


--
-- TOC entry 2853 (class 2604 OID 32117)
-- Name: leitoras id; Type: DEFAULT; Schema: config; Owner: postgres
--

ALTER TABLE ONLY config.leitoras ALTER COLUMN id SET DEFAULT nextval('config.leitoras_id_seq'::regclass);


--
-- TOC entry 2781 (class 2604 OID 31601)
...
--
-- TOC entry 2787 (class 2604 OID 31602)
...
--
-- TOC entry 2789 (class 2604 OID 31603)
...
--
-- TOC entry 2791 (class 2604 OID 31604)
...
--
-- TOC entry 2801 (class 2604 OID 31605)
...
--
-- TOC entry 2803 (class 2604 OID 31606)
...
--
-- TOC entry 2805 (class 2604 OID 31607)
...
--
-- TOC entry 2784 (class 2604 OID 31608)
...
--
-- TOC entry 2807 (class 2604 OID 31609)
...
--
-- TOC entry 2809 (class 2604 OID 31610)
...
--
-- TOC entry 2811 (class 2604 OID 31611)
...
--
-- TOC entry 2813 (class 2604 OID 31612)
...
--
-- TOC entry 2815 (class 2604 OID 31613)
...
--
-- TOC entry 2817 (class 2604 OID 31614)
...
--
-- TOC entry 2818 (class 2604 OID 31615)
...
--
-- TOC entry 2822 (class 2604 OID 31616)
...
--
-- TOC entry 2824 (class 2604 OID 31617)
...
--
-- TOC entry 2826 (class 2604 OID 31618)
...
--
-- TOC entry 2828 (class 2604 OID 31620)
...
--
-- TOC entry 2830 (class 2604 OID 31621)
...
--
-- TOC entry 2820 (class 2604 OID 31622)
...
--
-- TOC entry 2832 (class 2604 OID 31623)
...
--
-- TOC entry 2834 (class 2604 OID 31624)
...
--
-- TOC entry 2836 (class 2604 OID 31625)
...
--
-- TOC entry 2838 (class 2604 OID 31626)
...
--
-- TOC entry 2840 (class 2604 OID 31627)
...
--
-- TOC entry 2842 (class 2604 OID 31628)
...
--
-- TOC entry 2849 (class 2604 OID 32084)
...
--
-- TOC entry 2844 (class 2604 OID 31630)
...
--
-- TOC entry 2847 (class 2604 OID 32075)
-- Name: tipo_inventario id; Type: DEFAULT; Schema: operacional; Owner: postgres
--

ALTER TABLE ONLY operacional.tipo_inventario ALTER COLUMN id SET DEFAULT nextval('operacional.tipo_inventario_id_seq'::regclass);


--
-- TOC entry 2846 (class 2604 OID 31631)
...
--
-- TOC entry 3142 (class 0 OID 31138)
-- Dependencies: 203
...
--
-- TOC entry 3144 (class 0 OID 31147)
-- Dependencies: 205
...
--
-- TOC entry 3146 (class 0 OID 31156)
-- Dependencies: 207
...
--
-- TOC entry 3148 (class 0 OID 31165)
-- Dependencies: 209
...
--
-- TOC entry 3150 (class 0 OID 31174)
-- Dependencies: 211
...
--
-- TOC entry 3152 (class 0 OID 31183)
-- Dependencies: 213
...
--
-- TOC entry 3154 (class 0 OID 31192)
-- Dependencies: 215
...
--
-- TOC entry 3156 (class 0 OID 31201)
-- Dependencies: 217
...
--
-- TOC entry 3158 (class 0 OID 31210)
-- Dependencies: 219
...
--
-- TOC entry 3160 (class 0 OID 31219)
-- Dependencies: 221
...
--
-- TOC entry 3162 (class 0 OID 31228)
-- Dependencies: 223
...
--
-- TOC entry 3164 (class 0 OID 31237)
-- Dependencies: 225
...
--
-- TOC entry 3166 (class 0 OID 31248)
-- Dependencies: 227
...
--
-- TOC entry 3168 (class 0 OID 31257)
-- Dependencies: 229
...
--
-- TOC entry 3170 (class 0 OID 31266)
-- Dependencies: 231
...
--
-- TOC entry 3172 (class 0 OID 31275)
-- Dependencies: 233
...
--
-- TOC entry 3174 (class 0 OID 31284)
-- Dependencies: 235
...
--
-- TOC entry 3176 (class 0 OID 31293)
-- Dependencies: 237
...
--
-- TOC entry 3250 (class 0 OID 40384)
-- Dependencies: 311
-- Data for Name: artigos_globais; Type: TABLE DATA; Schema: cms; Owner: postgres
--

INSERT INTO cms.artigos_globais (id, firstdate, lastdate, purgedate, firstuser, lasttuser, purgeuser, titulo, resumo, arquivo, autor, imagem) VALUES (7, '2019-10-21 18:55:13.035615', NULL, NULL, 'oberdan', NULL, NULL, 'Guia sobre animais (cães, gatos,..) em condomínio', 'Se o cachorro é o melhor amigo do homem, é também uma das maiores dores de cabeça da vida em
                        condomínio. Afinal, lidar com as particularidades de animais e donos não é tarefa das mais
                        fáceis para o síndico...', './html/feeds/artigo2.html', 'João Albino', './html/feeds/cachorro_956_667.jpg');
INSERT INTO cms.artigos_globais (id, firstdate, lastdate, purgedate, firstuser, lasttuser, purgeuser, titulo, resumo, arquivo, autor, imagem) VALUES (5, '2019-10-21 18:53:16.30598', NULL, NULL, 'oberdan', NULL, NULL, 'O que caracteriza Alteração de Fachada do condomínio', 'Querer pintar uma parede, trocar uma esquadria ou fechar uma sacada parece uma vontade inocente e até rotineira. Mas em um condomínio, não é. Ela pode gerar muita confusão se avançar para áreas comuns ou para a fachada do condomínio...', './html/feeds/artigo1.html', 'João Albino', './html/feeds/fachada_956_667.jpg');
INSERT INTO cms.artigos_globais (id, firstdate, lastdate, purgedate, firstuser, lasttuser, purgeuser, titulo, resumo, arquivo, autor, imagem) VALUES (8, '2019-10-21 18:56:29.122377', NULL, NULL, 'oberdan', NULL, NULL, 'Guia sobre Barulho em Condomínios', 'Em condomínios, o barulho é um dos campeões de reclamação. Há diversos tipos: barulho de festa, de bagunça de criança nas áreas comuns em horários proibidos, dentro dos apartamentos durante o dia todo, ou aquele barulho que vem de fora do condomínio, de bares, casas noturnas, ou até do prédio ao lado...', './html/feeds/artigo3.html', 'João Albino', './html/feeds/barulho_956_667.jpg');
INSERT INTO cms.artigos_globais (id, firstdate, lastdate, purgedate, firstuser, lasttuser, purgeuser, titulo, resumo, arquivo, autor, imagem) VALUES (9, '2019-10-21 19:06:08.146193', NULL, NULL, 'oberdan', NULL, NULL, 'Acabe de vez com as goteiras na garagem do condomínio', 'O fato é que ninguém convive bem com goteiras na garagem. Nem os gestores nem os moradores. As poças que marcam o chão e prejudicam a limpeza são só o começo do problema...', './html/feeds/artigo3.html', 'Renato Brito', './html/feeds/goteira.PNG');


--
-- TOC entry 3178 (class 0 OID 31302)
-- Dependencies: 239
...
--
-- TOC entry 3248 (class 0 OID 32128)
-- Dependencies: 309
-- Data for Name: acionadores; Type: TABLE DATA; Schema: config; Owner: postgres
--



--
-- TOC entry 3180 (class 0 OID 31311)
-- Dependencies: 241
...
--
-- TOC entry 3244 (class 0 OID 32100)
-- Dependencies: 305
-- Data for Name: controladoras; Type: TABLE DATA; Schema: config; Owner: postgres
--



--
-- TOC entry 3246 (class 0 OID 32114)
-- Dependencies: 307
-- Data for Name: leitoras; Type: TABLE DATA; Schema: config; Owner: postgres
--



--
-- TOC entry 3182 (class 0 OID 31320)
-- Dependencies: 243
...
--
-- TOC entry 3186 (class 0 OID 31339)
-- Dependencies: 247
...
--
-- TOC entry 3188 (class 0 OID 31349)
-- Dependencies: 249
...
--
-- TOC entry 3190 (class 0 OID 31358)
-- Dependencies: 251
...
--
-- TOC entry 3192 (class 0 OID 31367)
-- Dependencies: 253
...
--
-- TOC entry 3194 (class 0 OID 31384)
-- Dependencies: 255
...
--
-- TOC entry 3196 (class 0 OID 31393)
-- Dependencies: 257
...
--
-- TOC entry 3184 (class 0 OID 31329)
-- Dependencies: 245
...
--
-- TOC entry 3198 (class 0 OID 31402)
-- Dependencies: 259
...
--
-- TOC entry 3199 (class 0 OID 31406)
-- Dependencies: 260
...
--
-- TOC entry 3201 (class 0 OID 31415)
-- Dependencies: 262
...
--
-- TOC entry 3203 (class 0 OID 31424)
-- Dependencies: 264
...
--
-- TOC entry 3206 (class 0 OID 31435)
-- Dependencies: 267
...
--
-- TOC entry 3208 (class 0 OID 31441)
-- Dependencies: 269
...
--
-- TOC entry 3213 (class 0 OID 31458)
-- Dependencies: 274
...
--
-- TOC entry 3215 (class 0 OID 31464)
-- Dependencies: 276
...
--
-- TOC entry 3217 (class 0 OID 31473)
-- Dependencies: 278
...
--
-- TOC entry 3219 (class 0 OID 31491)
-- Dependencies: 280
...
--
-- TOC entry 3221 (class 0 OID 31500)
-- Dependencies: 282
...
--
-- TOC entry 3211 (class 0 OID 31449)
-- Dependencies: 272
...
--
-- TOC entry 3223 (class 0 OID 31509)
-- Dependencies: 284
...
--
-- TOC entry 3225 (class 0 OID 31515)
-- Dependencies: 286
...
--
-- TOC entry 3227 (class 0 OID 31524)
-- Dependencies: 288
...
--
-- TOC entry 3229 (class 0 OID 31530)
-- Dependencies: 290
...
--
-- TOC entry 3231 (class 0 OID 31536)
-- Dependencies: 292
...
--
-- TOC entry 3233 (class 0 OID 31545)
-- Dependencies: 294
...
--
-- TOC entry 3242 (class 0 OID 32081)
-- Dependencies: 303
...
--
-- TOC entry 3235 (class 0 OID 31563)
-- Dependencies: 296
...
--
-- TOC entry 3240 (class 0 OID 32072)
-- Dependencies: 301
-- Data for Name: tipo_inventario; Type: TABLE DATA; Schema: operacional; Owner: postgres
--



--
-- TOC entry 3237 (class 0 OID 31572)
-- Dependencies: 298
...
-- Dependencies: 310
-- Name: artigos_globais_id_seq; Type: SEQUENCE SET; Schema: cms; Owner: postgres
--

SELECT pg_catalog.setval('cms.artigos_globais_id_seq', 9, true);
...
-- Dependencies: 308
-- Name: acionadores_id_seq; Type: SEQUENCE SET; Schema: config; Owner: postgres
--

SELECT pg_catalog.setval('config.acionadores_id_seq', 1, false);
...
-- Dependencies: 304
-- Name: controladoras_id_seq; Type: SEQUENCE SET; Schema: config; Owner: postgres
--

SELECT pg_catalog.setval('config.controladoras_id_seq', 1, false);


--
-- TOC entry 3389 (class 0 OID 0)
-- Dependencies: 306
-- Name: leitoras_id_seq; Type: SEQUENCE SET; Schema: config; Owner: postgres
--

SELECT pg_catalog.setval('config.leitoras_id_seq', 1, false);
...
-- Dependencies: 300
-- Name: tipo_inventario_id_seq; Type: SEQUENCE SET; Schema: operacional; Owner: postgres
--

SELECT pg_catalog.setval('operacional.tipo_inventario_id_seq', 1, false);
...
--
-- TOC entry 2860 (class 2606 OID 31633)
...
--
-- TOC entry 2862 (class 2606 OID 31635)
...
--
-- TOC entry 2864 (class 2606 OID 31637)
...
--
-- TOC entry 2866 (class 2606 OID 31639)
...
--
-- TOC entry 2868 (class 2606 OID 31641)
...
--
-- TOC entry 2870 (class 2606 OID 31643)
...
--
-- TOC entry 2872 (class 2606 OID 31645)
...
--
-- TOC entry 2874 (class 2606 OID 31647)
...
--
-- TOC entry 2876 (class 2606 OID 31649)
...
--
-- TOC entry 2878 (class 2606 OID 31651)
...
--
-- TOC entry 2880 (class 2606 OID 31653)
...
--
-- TOC entry 2882 (class 2606 OID 31655)
...
--
-- TOC entry 2884 (class 2606 OID 31657)
...
--
-- TOC entry 2886 (class 2606 OID 31659)
...
--
-- TOC entry 2888 (class 2606 OID 31661)
...
--
-- TOC entry 2890 (class 2606 OID 31663)
...
--
-- TOC entry 2892 (class 2606 OID 31665)
...
--
-- TOC entry 2894 (class 2606 OID 31667)
...
--
-- TOC entry 2966 (class 2606 OID 40393)
-- Name: artigos_globais primarykey_cms_artigos_globais; Type: CONSTRAINT; Schema: cms; Owner: postgres
--

ALTER TABLE ONLY cms.artigos_globais
    ADD CONSTRAINT primarykey_cms_artigos_globais PRIMARY KEY (id);


--
-- TOC entry 2896 (class 2606 OID 31669)
...
--
-- TOC entry 2898 (class 2606 OID 31671)
...
--
-- TOC entry 2964 (class 2606 OID 32134)
-- Name: acionadores primarykey_config_acionadores; Type: CONSTRAINT; Schema: config; Owner: postgres
--

ALTER TABLE ONLY config.acionadores
    ADD CONSTRAINT primarykey_config_acionadores PRIMARY KEY (id);


--
-- TOC entry 2960 (class 2606 OID 32106)
-- Name: controladoras primarykey_config_controladoras; Type: CONSTRAINT; Schema: config; Owner: postgres
--

ALTER TABLE ONLY config.controladoras
    ADD CONSTRAINT primarykey_config_controladoras PRIMARY KEY (id);


--
-- TOC entry 2962 (class 2606 OID 32120)
-- Name: leitoras primarykey_config_leitoras; Type: CONSTRAINT; Schema: config; Owner: postgres
--

ALTER TABLE ONLY config.leitoras
    ADD CONSTRAINT primarykey_config_leitoras PRIMARY KEY (id);


--
-- TOC entry 2900 (class 2606 OID 31673)
...
--
-- TOC entry 2918 (class 2606 OID 31675)
...
--
-- TOC entry 2920 (class 2606 OID 31677)
...
--
-- TOC entry 2922 (class 2606 OID 31679)
...
--
-- TOC entry 2902 (class 2606 OID 31681)
...
--
-- TOC entry 2904 (class 2606 OID 31683)
...
--
-- TOC entry 2906 (class 2606 OID 31685)
...
--
-- TOC entry 2908 (class 2606 OID 31687)
...
--
-- TOC entry 2910 (class 2606 OID 31689)
...
--
-- TOC entry 2912 (class 2606 OID 31691)
...
--
-- TOC entry 2914 (class 2606 OID 31693)
...
--
-- TOC entry 2916 (class 2606 OID 31695)
...
--
-- TOC entry 2924 (class 2606 OID 31697)
...
--
-- TOC entry 2926 (class 2606 OID 31699)
...
--
-- TOC entry 2928 (class 2606 OID 31701)
...
--
-- TOC entry 2930 (class 2606 OID 31703)
...
--
-- TOC entry 2932 (class 2606 OID 31705)
...
--
-- TOC entry 2934 (class 2606 OID 31707)
...
--
-- TOC entry 2936 (class 2606 OID 31711)
...
--
-- TOC entry 2938 (class 2606 OID 31713)
...
--
-- TOC entry 2940 (class 2606 OID 31715)
...
--
-- TOC entry 2944 (class 2606 OID 31717)
...
--
-- TOC entry 2946 (class 2606 OID 31719)
...
--
-- TOC entry 2950 (class 2606 OID 31721)
...
--
-- TOC entry 2942 (class 2606 OID 31723)
...
--
-- TOC entry 2948 (class 2606 OID 31725)
...
--
-- TOC entry 2958 (class 2606 OID 32087)
...
--
-- TOC entry 2952 (class 2606 OID 31729)
...
--
-- TOC entry 2956 (class 2606 OID 32078)
-- Name: tipo_inventario primarykey_operacional_tipo_inventario; Type: CONSTRAINT; Schema: operacional; Owner: postgres
--

ALTER TABLE ONLY operacional.tipo_inventario
    ADD CONSTRAINT primarykey_operacional_tipo_inventario PRIMARY KEY (id);


--
-- TOC entry 2954 (class 2606 OID 31731)
...
--
-- TOC entry 2967 (class 2606 OID 31732)
...
--
-- TOC entry 2968 (class 2606 OID 31737)
...
--
-- TOC entry 2969 (class 2606 OID 31742)
...
--
-- TOC entry 2970 (class 2606 OID 31747)
...
--
-- TOC entry 2971 (class 2606 OID 31752)
...
--
-- TOC entry 2972 (class 2606 OID 31757)
...
--
-- TOC entry 2973 (class 2606 OID 31762)
...
--
-- TOC entry 2974 (class 2606 OID 31767)
...
--
-- TOC entry 2975 (class 2606 OID 31772)
...
--
-- TOC entry 2976 (class 2606 OID 31777)
...
--
-- TOC entry 2977 (class 2606 OID 31782)
...
--
-- TOC entry 2978 (class 2606 OID 31787)
...
--
-- TOC entry 2979 (class 2606 OID 31792)
...
--
-- TOC entry 2980 (class 2606 OID 31797)
...
--
-- TOC entry 2981 (class 2606 OID 31802)
...
--
-- TOC entry 2982 (class 2606 OID 31807)
...
--
-- TOC entry 2983 (class 2606 OID 31812)
...
--
-- TOC entry 2984 (class 2606 OID 31817)
...
--
-- TOC entry 3019 (class 2606 OID 32121)
-- Name: leitoras operacional_controladoras_foreignkey; Type: FK CONSTRAINT; Schema: config; Owner: postgres
--

ALTER TABLE ONLY config.leitoras
    ADD CONSTRAINT operacional_controladoras_foreignkey FOREIGN KEY (controladora) REFERENCES config.controladoras(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 3018 (class 2606 OID 32107)
-- Name: controladoras operacional_inventario_foreignkey; Type: FK CONSTRAINT; Schema: config; Owner: postgres
--

ALTER TABLE ONLY config.controladoras
    ADD CONSTRAINT operacional_inventario_foreignkey FOREIGN KEY (inventario) REFERENCES operacional.inventario(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 3020 (class 2606 OID 32135)
-- Name: acionadores operacional_leitora_foreignkey; Type: FK CONSTRAINT; Schema: config; Owner: postgres
--

ALTER TABLE ONLY config.acionadores
    ADD CONSTRAINT operacional_leitora_foreignkey FOREIGN KEY (leitora) REFERENCES config.leitoras(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2985 (class 2606 OID 31822)
...
--
-- TOC entry 2986 (class 2606 OID 31827)
...
--
-- TOC entry 2987 (class 2606 OID 31832)
...
--
-- TOC entry 2988 (class 2606 OID 31837)
...
--
-- TOC entry 2989 (class 2606 OID 31842)
...
--
-- TOC entry 2990 (class 2606 OID 31847)
...
--
-- TOC entry 2991 (class 2606 OID 31852)
...
--
-- TOC entry 2992 (class 2606 OID 31857)
...
--
-- TOC entry 2993 (class 2606 OID 31862)
...
--
-- TOC entry 2994 (class 2606 OID 31867)
...
--
-- TOC entry 2995 (class 2606 OID 31983)
...
--
-- TOC entry 2996 (class 2606 OID 31877)
...
--
-- TOC entry 3000 (class 2606 OID 31882)
...
--
-- TOC entry 3001 (class 2606 OID 31887)
...
--
-- TOC entry 3002 (class 2606 OID 31892)
...
--
-- TOC entry 3003 (class 2606 OID 31897)
...
--
-- TOC entry 2997 (class 2606 OID 31902)
...
--
-- TOC entry 2998 (class 2606 OID 31907)
...
--
-- TOC entry 2999 (class 2606 OID 31912)
...
--
-- TOC entry 3004 (class 2606 OID 31917)
...
--
-- TOC entry 3005 (class 2606 OID 31922)
...
--
-- TOC entry 3006 (class 2606 OID 31988)
...
--
-- TOC entry 3007 (class 2606 OID 31932)
...
--
-- TOC entry 3008 (class 2606 OID 31937)
...
--
-- TOC entry 3009 (class 2606 OID 31942)
...
--
-- TOC entry 3010 (class 2606 OID 31947)
...
--
-- TOC entry 3011 (class 2606 OID 31952)
...
--
-- TOC entry 3012 (class 2606 OID 31957)
...
--
-- TOC entry 3013 (class 2606 OID 31962)
...
--
-- TOC entry 3014 (class 2606 OID 31967)
...
--
-- TOC entry 3016 (class 2606 OID 32088)
...
--
-- TOC entry 3017 (class 2606 OID 32093)
-- Name: inventario inventario_tipo_inventario_foreignkey; Type: FK CONSTRAINT; Schema: operacional; Owner: postgres
--

ALTER TABLE ONLY operacional.inventario
    ADD CONSTRAINT inventario_tipo_inventario_foreignkey FOREIGN KEY (tipo_inventario) REFERENCES operacional.tipo_inventario(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 3015 (class 2606 OID 31977)
...
-- Completed on 2019-10-24 12:29:51 -03
